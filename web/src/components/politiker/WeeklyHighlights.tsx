...
export function WeeklyHighlights({ politicians }: WeeklyHighlightsProps) {
  const highlights = useMemo(() => {
    ...
    return { effective, independent, mostPassed, mostQuestioning };
  }, [politicians]);

  if (!highlights || (!highlights.effective && !highlights.independent && !highlights.mostPassed && !highlights.mostQuestioning)) {
    return null;
  }
