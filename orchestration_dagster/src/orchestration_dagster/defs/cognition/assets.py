...
Partitioned by year for incremental processing and cost control.
"""

import dagster as dg
from dagster import AssetExecutionContext, AssetKey, TimeWindowPartitionsDefinition
...
# Yearly partitions starting from 2018 (first election year we support)
...
@dg.asset(
    ...
    deps=[AssetKey(["stg_snd", "stg_valmanifest"])],
