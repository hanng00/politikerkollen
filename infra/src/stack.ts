...
export class PolitikerkollenStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: PolitikerkollenStackProps) {
    ...
    // No public ingress - access via SSM port forwarding only
    ...
    // Secrets Manager
    // =========================================================================
    this.motherDuckSecret = new secretsmanager.Secret(
      this,
      "MotherDuckSecret",
      {
    ...
    const dagsterPostgresSecret = new secretsmanager.Secret(
      this,
      "DagsterPostgresSecret",
      {
