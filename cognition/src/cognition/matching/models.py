"""
Pydantic models for promise-vote matching.
...
class PromiseVoteMatch(BaseModel):
    """
    A match between a promise and a vote based on semantic similarity.

    Matches are generated by computing cosine similarity between
    promise embeddings and vote embeddings.
    """
    ...
    votering_id: str = Field(description="FK to vote_embeddings.votering_id")
